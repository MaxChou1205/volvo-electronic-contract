  ...
  <div class="mx-auto max-w-screen-md">
    ...
    <div class="text-black-400 mt-8 px-15 pb-15">
      ...
      <div class="flex items-baseline justify-between">
        ...
        <div>
          <div class="mb-3 flex items-center justify-self-end">
            ...
            <CurrencyInput
              class="mx-2 w-55"
              v-model.number="form.order.vehicleDealAllAmount"
            />
            元
          </div>
          <div class="text-end">
            ...
            <span class="text-blue-500">{{
              toZhDigit(form.order.vehicleDealAllAmount ?? 0)
            }}</span>
            元整
          </div>
        </div>
      ...
      <div class="mb-4">
        ...
        <div
          class="font-light"
          v-if="String(form.order.payMode) === '14261002'"
        >
      ...
      <div class="space-y-8">
        <div>
          ...
          <div
            v-if="
              v$Checkbox.contractAgreement.$dirty &&
              v$Checkbox.contractAgreement.$invalid
            "
          >
            <span class="error">{{
              v$Checkbox.contractAgreement.$errors[0]!.$message
            }}</span>
          </div>
        </div>
        <div>
          ...
          <div
            v-if="
              v$Checkbox.confidentialityAgreement.$dirty &&
              v$Checkbox.confidentialityAgreement.$invalid
            "
          >
            <span class="error">{{
              v$Checkbox.confidentialityAgreement.$errors[0]!.$message
            }}</span>
          </div>
        </div>
        <div>
          ...
          <div
            v-if="
              v$Checkbox.vipAgreement.$dirty && v$Checkbox.vipAgreement.$invalid
            "
          >
            <span class="error">{{
              v$Checkbox.vipAgreement.$errors[0]!.$message
            }}</span>
          </div>
        </div>
        <div>
          <Checkbox v-model="agreementForm.reviewAgreement" :value="true"
            >已詳讀並經過3日審閱期的同意勾選</Checkbox
          >
          <div
            v-if="
              v$Checkbox.reviewAgreement.$dirty &&
              v$Checkbox.reviewAgreement.$invalid
            "
          >
            <span class="error">{{
              v$Checkbox.reviewAgreement.$errors[0]!.$message
            }}</span>
          </div>
          <div>
        ...
        <div>
          <Checkbox v-model="agreementForm.agreement" :value="true"
            >本人已詳讀並同意</Checkbox
          >
          <div
            v-if="v$Checkbox.agreement.$dirty && v$Checkbox.agreement.$invalid"
          >
            <span class="error">{{
              v$Checkbox.agreement.$errors[0]!.$message
            }}</span>
          </div>
        </div>
        <div class="grid grid-cols-[144px_1fr_144px] gap-x-6 gap-y-3">
          ...
          <div>
            ...
            <div v-if="v$.$dirty && v$.customerSignatureBase64.$invalid">
              <span class="error">{{
                v$.customerSignatureBase64.$errors[0].$message
              }}</span>
            </div>
          </div>
          <div
          ...
          <div>
            ...
            <div v-if="v$.$dirty && v$.consultantSignatureBase64.$invalid">
              <span class="error">{{
                v$.consultantSignatureBase64.$errors[0].$message
              }}</span>
            </div>
          </div>
        </div>
...
const totalPrice = computed(() => {
  return (
    ...
    form.value.order.personalityOptionVOList.reduce(
...
const checkboxValidationRules = {
  contractAgreement: {
    required: helpers.withMessage("請同意條款", (value) => value === true),
  },
